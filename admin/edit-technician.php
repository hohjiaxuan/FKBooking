...
$id=$_GET['id'];
$query="update technician set username=?, email=?, password=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssi',$username,$email,$password,$id);
$stmt->execute();
echo"<script>alert('Technician details has been updated.');</script>";
}
?>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Technician Details </h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											<?php	
											$id=$_GET['id'];
											$ret="select * from technician where id=?";
										...
										<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-2 control-label">Technician ID :</label>
												<div class="col-sm-8">
											...
											<?php } ?>
												...
												<div class="col-sm-8 col-sm-offset-2">
													<input class="btn btn-primary" type="submit" name="submit" value="Update Technician Details ">
												</div>
											</div>

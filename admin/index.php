			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">FK BOOKING SYSTEM (ADMIN)</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn-primary btn-block" style="font-size: 15px" value="Login" >
								</form>
							</div>
						</div>
					</div>

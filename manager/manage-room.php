                            ...
                            <div class="panel-body">
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    <thead>
                                     ...
                                     <tr style="background-color:#20baad;color:#000000">
                                            <th colspan="8">
                                                <center>LECTURE HALL</center>
                                            </th>
                                        </tr>
                                    <tbody>
                                        <?php	
$aid=$_SESSION['id'];
$ret="SELECT * FROM room WHERE category = 'LECTURE HALL' ";
...
$cnt=$cnt+1;
                                        ...
                                        <?php	
$aid=$_SESSION['id'];
$ret="SELECT * FROM room WHERE category = 'LAB' ";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;//ok
$res=$stmt->get_result();
...
$cnt=$cnt+1;
                                        ...
                                        <?php	
$aid=$_SESSION['id'];
$ret="SELECT * FROM room WHERE category = 'MEETING ROOM' ";
$stmt= $mysqli->prepare($ret) ;
//$stmt->bind_param('i',$aid);
$stmt->execute() ;//ok
$res=$stmt->get_result();

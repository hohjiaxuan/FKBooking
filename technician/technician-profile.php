...
$aid=$_SESSION['id'];
$udate=date('Y-m-d');
$query="update technician set email=?,updation_date=? where id=?";
...
$ai=$_SESSION['id'];
$udate=date('Y-m-d');
	$sql="SELECT password FROM technician where password=?";
	...
	if($row_cnt>0)
	{
		$con="update technician set password=?,updation_date=?  where id=?";
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Technician profile details</div>

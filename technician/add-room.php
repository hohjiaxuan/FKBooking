...
$date=$_POST['date'];
$tic=$_POST['tic'];
$requiredset=$_POST['requiredset'];

$query="insert into courses(category,roomname,status,location,date,tic,requiredset) values(?,?,?,?,?,?,?)";

$stmt1 = $mysqli->prepare($query);

$rc1=$stmt1->bind_param('sssssss',$category,$roomname,$status,$location,$date,$tic,$requiredset);
									...
									<form method="post" action="" name="booking" class="form-horizontal" onSubmit="return valid();">
                                        ...
                                        <div class="form-group">
												...
												<option value="NO ONE">NO ONE</option>
                                                        ...
                                                        <option value="SHAHRUL">SHAHRUL</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
												<input type="text" class="form-control" name="requiredset" value="" >
                                                </div>
                                            </div>

	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
					...
					<div class="col-sm-8">
					<input type="text"  name="roomname" value="<?php echo $row->roomname;?>"  class="form-control" disabled> </div>
					</div>

				 	<div class="form-group">
					<label class="col-sm-2 control-label">Location</label>
					<div class="col-sm-8">
					<input type="text" class="form-control" name="location" id="location" value="<?php echo $row->location;?>" disabled required="required">
					</div>
					</div>
					...
					<input type="text" class="form-control" name="tic" value="<?php echo $row->tic;?>"  disabled>
										...
										<label class="col-sm-6 control-label"><h4 style="color: green">Please fill this information </h4> </label>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Room Name</label>
												<div class="col-sm-8">
												<input type="text"  name="Room_Name" value="<?php echo $row->roomname;?>"   class="form-control">
												</div>
											</div>
